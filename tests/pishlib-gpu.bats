...
@test "GPU 2.0 pl_gpu memory total" {
  run pl_gpu memory total
  [[ $output =~ [1-9][0-9]+ ]]
}

@test "GPU 2.1 pl_gpu memory total=128: blank config.txt" {
...
@test "GPU 2.2 pl_gpu memory total=8: insane setting, return 1." {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.3 pl_gpu memory total=1024: insane setting, return 1." {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.4 pl_gpu memory total=128: gpu_mem already defined in config.txt" {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.5 pl_gpu memory total=128: gpu_mem commented out in config.txt" {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
  cat <<EOF > $BOOT_CONF_FILE
# gpu_mem=76
...
@test "GPU 2.6 pl_gpu memory total=default: Pi mem < 1024" {
...
@test "GPU 2.7 pl_gpu memory total=default: Pi mem > 1024" {
  # TODO: fake system memory size
  skip "Need to implement fake system memory size."
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.8 pl_gpu memory total=max: Pi mem = 256." {
  # TODO: fake system memory size
  skip "Need to implement fake system memory size."
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.9 pl_gpu memory total=max: Pi mem = 512." {
  # TODO: fake system memory size
  skip "Need to implement fake system memory size."
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 2.10 pl_gpu memory total=max: Pi mem > 512." {
  # TODO: fake system memory size
  skip "Need to implement fake system memory size."
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 3.0 pl_gpu memory free" {
  run pl_gpu memory free
  [[ $output =~ [0-9]+ ]]
}

@test "GPU 3.1 pl_gpu memory free: no vcgencmd" {
  VCGENCMD=""
  run pl_gpu memory free
  [[ $output =~ [0-9]+ ]]
}

@test "GPU 4.0 pl_gpu memory used" {
  run pl_gpu memory used
  [[ $output =~ [0-9]+ ]]
}


@test "GPU 4.1 pl_gpu memory used: no vcgencmd" {
  VCGENCMD=""
  run pl_gpu memory used
  [[ $output =~ [0-9]+ ]]
}

@test "GPU 5.0 pl_gpu model_memory: Pi mem 256." {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 5.1 pl_gpu model_memory: Pi mem 512." {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 5.2 pl_gpu model_memory: Pi mem 1024." {
  touch ~/tmp_boot_conf.txt
  BOOT_CONF_FILE=~/tmp_boot_conf.txt # overide pishlib
...
@test "GPU 6.0 pl_gpu temperature" {
